    ...
    implements IProjectionDelegate
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        LatLng localLatLng2 = fromScreenLocation(b.a.z(paramParcel1.readStrongBinder()));
      ...
      implements IProjectionDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   32: aload_0
        //   33: getfield 15	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:dG	Landroid/os/IBinder;
        //   36: iconst_1
        //   37: aload_2
        //   38: aload_3
        //   39: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   11: invokevirtual 33	android/os/Parcel:writeInterfaceToken	(Ljava/lang/String;)V
        //   14: aload_0
        //   15: getfield 15	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:dG	Landroid/os/IBinder;
        //   18: iconst_3
        //   19: aload_1
        //   20: aload_2
        //   21: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 15	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:dG	Landroid/os/IBinder;
        //   33: iconst_2
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
        ...
        //   51: invokestatic 99	com/google/android/gms/dynamic/b$a:z	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/b;
        //   54: astore 6
        //   56: aload_3
        //   57: invokevirtual 68	android/os/Parcel:recycle	()V
        //   60: aload_2
