  ...
  extends IInterface
{
    ...
    implements IMapFragmentDelegate
  {
      ...
      throws RemoteException
    {
      ...
      case 2: 
        paramParcel1.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
        b localb4 = b.a.z(paramParcel1.readStrongBinder());
      ...
      implements IMapFragmentDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 15	com/google/android/gms/maps/internal/IMapFragmentDelegate$a$a:dG	Landroid/os/IBinder;
        //   33: iconst_3
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   75: aload_0
        //   76: getfield 15	com/google/android/gms/maps/internal/IMapFragmentDelegate$a$a:dG	Landroid/os/IBinder;
        //   79: iconst_4
        //   80: aload 4
        //   82: aload 5
        //   84: iconst_0
        ...
        //   101: invokestatic 87	com/google/android/gms/dynamic/b$a:z	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/b;
        //   104: astore 10
        //   106: aload 5
