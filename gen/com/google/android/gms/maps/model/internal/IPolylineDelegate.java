  ...
  extends IInterface
{
    ...
    implements IPolylineDelegate
  {
      ...
      throws RemoteException
    {
      ...
      case 15: 
        paramParcel1.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
        boolean bool1 = equalsRemote(ah(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        int j = 0;
        if (bool1) {
          j = 1;
      ...
      implements IPolylineDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   32: aload_0
        //   33: getfield 15	com/google/android/gms/maps/model/internal/IPolylineDelegate$a$a:dG	Landroid/os/IBinder;
        //   36: bipush 15
        //   38: aload_2
        //   39: aload_3
        //   40: iconst_0
