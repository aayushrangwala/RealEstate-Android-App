...
public final class PlusShare
{
  ...
  public static class Builder
  {
    ...
    {
      int i = 1;
      if ((this.rm != null) && (this.rm.size() > i))
      {
        int k = i;
        ...
        int n = i;
        label59:
        dm.a(n, "Call-to-action buttons are only available for URLs.");
        if ((bool2) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL"))) {
          break label308;
        }
        int i2 = i;
        label86:
        dm.a(i2, "The content URL is required for interactive posts.");
        ...
        label122:
        dm.a(i, "Must set content URL or content deep-link ID to use a call-to-action button.");
