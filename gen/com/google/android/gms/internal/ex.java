    ...
    implements ex
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        ArrayList localArrayList = paramParcel1.createTypedArrayList(fa.CREATOR);
        ...
        a(localArrayList, localPendingIntent6, ew.a.E(paramParcel1.readStrongBinder()), paramParcel1.readString());
      ...
      case 2: 
        ...
        a(localPendingIntent5, ew.a.E(paramParcel1.readStrongBinder()), paramParcel1.readString());
        paramParcel2.writeNoException();
        return true;
      case 3: 
        paramParcel1.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
      ...
      case 8: 
        ...
        a(localLocationRequest3, a.a.D(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 9: 
        paramParcel1.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
      ...
      a(localLocationRequest1, a.a.D(paramParcel1.readStrongBinder()), paramParcel1.readString());
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements ex
    {
        ...
        throws RemoteException
      {
        ...
        //   56: aload_0
        //   57: getfield 15	com/google/android/gms/internal/ex$a$a:dG	Landroid/os/IBinder;
        //   60: iconst_5
        //   61: aload 6
        //   63: aload 7
        //   65: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 15	com/google/android/gms/internal/ex$a$a:dG	Landroid/os/IBinder;
        //   33: bipush 11
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   38: aload_0
        //   39: getfield 15	com/google/android/gms/internal/ex$a$a:dG	Landroid/os/IBinder;
        //   42: iconst_4
        //   43: aload_3
        //   44: aload 4
        //   46: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   32: aload_0
        //   33: getfield 15	com/google/android/gms/internal/ex$a$a:dG	Landroid/os/IBinder;
        //   36: bipush 10
        //   38: aload_2
        //   39: aload_3
        //   40: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   48: aload_0
        //   49: getfield 15	com/google/android/gms/internal/ex$a$a:dG	Landroid/os/IBinder;
        //   52: iconst_3
        //   53: aload 4
        //   55: aload 5
        //   57: iconst_0
        ...
        throws RemoteException
      {
        ...
        //   11: invokevirtual 31	android/os/Parcel:writeInterfaceToken	(Ljava/lang/String;)V
        //   14: aload_0
        //   15: getfield 15	com/google/android/gms/internal/ex$a$a:dG	Landroid/os/IBinder;
        //   18: bipush 7
        //   20: aload_1
        //   21: aload_2
        //   22: iconst_0
